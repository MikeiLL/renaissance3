...
<?php require($template->get_template_dir('/tpl_modules_social_add_this.php',DIR_WS_TEMPLATE, $current_page_base,'templates'). '/tpl_modules_social_add_this.php'); ?>
</div>
<!--eof Social Add this  -->

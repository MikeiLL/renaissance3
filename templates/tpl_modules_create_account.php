...
<!-- bof CAPTCHA Account Validation Code for Zen-Cart v1.5.0 -->
<?php
if (ACCOUNT_VALIDATION == 'true') {
?>

<?php 
if (($_GET['main_page'] == 'create_account') && (CREATE_ACCOUNT_VALIDATION == 'true') || ($_GET['main_page'] == 'login') && (CREATE_ACCOUNT_VALIDATION == 'true')) { 
?>
...
<!-- eof CAPTCHA Account Validation Code for Zen-Cart v1.5.0 -->
<?php
